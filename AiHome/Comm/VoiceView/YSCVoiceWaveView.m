...
//    self.backgroundColor = [[UIColor blueColor] colorWithAlphaComponent:0.3];
    self.frame = CGRectMake(0, parentView.bounds.size.height * 0.25, parentView.bounds.size.width, parentView.bounds.size.height-parentView.bounds.size.height * 0.25);
    [self setup];
