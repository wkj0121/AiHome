...
@implementation TouchIDAuthenticate
...
- (void)sendNotice{
    NSLog(@"sendNotice. ");
    //发出通知
//    NSDictionary *dic = @{@"name":@"coputer",@"message":@"using"};
    [[NSNotificationCenter defaultCenter] postNotificationName:@"eventTouchID" object:self userInfo:@{@"isVaild":[NSNumber numberWithBool:isVaild]}];
}
