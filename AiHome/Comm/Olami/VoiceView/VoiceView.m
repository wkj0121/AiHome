...
- (void)setupUI {
    ...
    [self insertSubview:self.voiceWaveParentView atIndex:0];//insertSubView index设置0为最底层
...
- (UIView *)voiceWaveParentView
{
    if (!_voiceWaveParentView) {
        ...
        _voiceWaveParentView.frame = CGRectMake(0, 0 , self.frame.size.width, self.frame.size.height);
    }
